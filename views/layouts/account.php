			...
			<div class="col-lg-6 col-md-12 order-lg-2 order-last header__main">
				<nav class="header__nav">
					<ul class="header__menu">
						...
						<li class="header__menu__item">
							<a href="#" class="header__menu__item__link">Аукционы</a>
						</li>
	...
	<div class="container">
		<div class="row">
			<div class="col-12 col-lg-3">
				<span class="personal__rating">Рейтинг: 800</span>
				<ul class="personal__list">
					<li class="personal__list__item">
						<a href="#"
						   class="personal__list__item__link link-active">Информация</a>
					</li>
					<li class="personal__list__item">
						<a href="#" class="personal__list__item__link">Подписка</a>
					</li>
					<li class="personal__list__item">
						<a href="#" class="personal__list__item__link">Мои ставки</a>
					</li>
					<li class="personal__list__item">
						<a href="#" class="personal__list__item__link">Мои финансы</a>
					</li>
					<li class="personal__list__item">
						<a href="#" class="personal__list__item__link">Безопасность</a>
					</li>
					<li class="personal__list__item">
						<a href="#" class="personal__list__item__link">Проверить авто</a>
					</li>
					<li class="personal__list__item">
						<a href="#" class="personal__list__item__link">FAQ</a>
					</li>
				</ul>
			</div>
